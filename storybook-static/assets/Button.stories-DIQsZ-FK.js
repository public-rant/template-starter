import{f as S}from"./index-DcZGqPg1.js";import{c as f}from"./Button-D9aydFHb.js";const x={title:"Example/Button",tags:["autodocs"],render:({label:B,...y})=>f({label:B,...y}),argTypes:{backgroundColor:{control:"color"},label:{control:"text"},onClick:{action:"onClick"},primary:{control:"boolean"},size:{control:{type:"select"},options:["small","medium","large"]}},args:{onClick:S()}},r={args:{primary:!0,label:"Button"}},e={args:{label:"Button"}},a={args:{size:"large",label:"Button"}},o={args:{size:"small",label:"Button"}};var s,t,n;r.parameters={...r.parameters,docs:{...(s=r.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    primary: true,
    label: 'Button'
  }
...
}`,...(b=(g=o.parameters)==null?void 0:g.docs)==null?void 0:b.source}}};const C=["Primary","Secondary","Large","Small"];export{a as Large,r as Primary,e as Secondary,o as Small,C as __namedExportsOrder,x as default};
